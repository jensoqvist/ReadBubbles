...
def main():
    ...
    position_numbers_from_pdf = PositionNumbers(pdf_extractor.pos_numbers_clean, settings= settings)
    ...
    df_handler.to_xl()
    xl_formater = XlFormater(xlhandler= xlreader, df_handler= df_handler, duplicates= pdf_extractor.duplicates, settings= settings)
    print("Done!")
